  ...
  //assumes that e1 will be to the Right of e2 ABOVE the intersection
    ...
    private void JoinCommonEdges()
      ...
      public static Paths MinkowskiSum(Path pattern, Path path, bool pathIsClosed)
      {
        ...
        c.Execute(ClipType.Union, paths, PolyFillType.pftNonZero, PolyFillType.pftNonZero);
        return paths;
      }
      //------------------------------------------------------------------------------
  ...
  public class ClipperOffset
  {
    ...
    public void Execute(ref Paths solution, double delta)
    {
      ...
      else
      {
        ...
        clpr.Execute(ClipType.Union, solution, PolyFillType.pftNegative, PolyFillType.pftNegative);
